...
//Class neuron has the neuron properties to be used in the network
class Neuron
{
public:
...
void Neuron::feedForward(const Layer &prevLayer)
{
	...
	// Sum the previous layer's outputs and including bias node
...
int main()
{
	TrainingData trainData("and.txt"); //change the training data file
	//e.g., {3, 2, 1 }
